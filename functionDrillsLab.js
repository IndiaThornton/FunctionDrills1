...
let colorRating = faveColorFinder('brown')
...
console.log(bestMovie('The Best Man'));
...
console.log(emailCheck('tatiannamartinezatgmail.com'))
...
let arrayIsAscending = arrayFunc(sampleArray)
